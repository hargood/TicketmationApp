...
Partial Class frmMainAN
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtSessionCounter.TabIndex = 38
        ...
        Me.lblSelectEvent.TabIndex = 33
        Me.lblSelectEvent.Text = "Current EVENT"
        '
        'cmdLog
        '
